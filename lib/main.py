...
#The matrix here has all values on the main diagional equals 0, and for the other it contains the distance between each particle
...
if ld==1:
    ...
    mat=light_perp(mat,particles,Gamma_1,N)
